function DateTime() {
    ...
    this.formats = {
        ...
        pretty: {
            ...
            b: this.sym.t.h + ":" + this.sym.t.mm + " " + this.sym.d.dddd + " " + this.sym.d.ddddd + " of " + this.sym.d.mmmm + ", " + this.sym.d.yyyy,
            c: this.sym.d.dddd + " " + this.sym.d.ddddd + " of " + this.sym.d.mmmm + ", " + this.sym.d.yyyy + ", " + this.sym.t.hhh + ":" + this.sym.t.mm
        }
    };
